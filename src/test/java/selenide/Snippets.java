...
public class Snippets {
    ...
    void assertions_examples() {
        ...
        // Технической разницы между Should and ShouldBe нет.
        //Но граматически по англ правильно Element button should be visible
    ...
    void conditions_examples() {
        $("").shouldBe(visible); // топ - 1
        $("").shouldBe(hidden); // топ - 2

        $("").shouldHave(text("abc")); // топ - 3
